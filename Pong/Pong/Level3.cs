    ...
    public partial class Level3 : Form
    {
        ...
        private void Level3_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Space)
            {
                ...
                if (PlayerScore >= 5)
                {
                    //creates an instance of the Level4 form and opens it.
                    Level4 Level4 = new Level4();
                    Level4.Show();

                    //sets Menu in reference so Level4 can open it again later
                    Level4.RefMenu = this.RefMenu;
        ...
        //Form size change
        private void Level3_ClientSizeChanged(object sender, EventArgs e)
        {
