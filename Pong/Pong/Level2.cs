    ...
    public partial class Level2 : Form
    {
        ...
        private void Level2_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Space)
            {
                ...
                if (PlayerScore >= 5)
                {
                    //creates an instance of the Level3 form and opens it.
                    Level3 Level3 = new Level3();
                    Level3.Show();

                    //sets Menu in reference so Level3 can open it again later
                    Level3.RefMenu = this.RefMenu;
        ...
        //Form size change
        private void Level2_ClientSizeChanged(object sender, EventArgs e)
        {
        ...
        public int ReverseBallSpeed(int n)
        {
            ...
            if (n > 0)
            {
                ...
                // limits number to between 25 and 35
                if (n < 35 && n > 25)
                {
                ...
                //if the number is outside the "acceptable speed range (25-35)" the else if and else will slowly set them back
                else if (n < 30)
                {
                    n = -(n) - 5;
                    return n;
            ...
            //i.e. the number was 0 (which it should never be) then this would reset the number to the middle speed 30.
            else
            {
                n = 30;
                return n;
