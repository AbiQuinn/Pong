...
namespace Pong
{
    public partial class Level1 : Form
    {
        ...
        private void TimerBall_Tick(object sender, EventArgs e)
        {
            ...
            if (Ball.Left >= PlayArea.Right - Ball.Width)
            {
                ...
                if (PlayerScore == 5)
                {
                    ...
                    Win.Visible = true;
                    Score.Top += 290;
                    Prompt.Text = "Press Space to go to the next Level!";
        ...
        {
            //if the top of the AI paddle is below the ball... Move upwards
            if (AI.Top > Ball.Top)
            {
                AI.Top -= 26;
            }

            //if the bottom of the AI paddle is above the ball... Move downwards
            if (AI.Top + AI.Height < Ball.Top + Ball.Height)
            {
                AI.Top += 26;
            }
        }
        ...
        private void Level1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                //on Esc. key press the game is closed and the menu is brought back up.
                this.Close();
                RefMenu.Show();
            }
            ...
            if (e.KeyCode == Keys.Space)
            {
                ...
                if (PlayerScore >= 5)
                {
                    //creates an instance of the Level2 form and opens it.
                    Level2 Level2 = new Level2();
                    Level2.Show();

                    //sets Menu in reference so Level2 can open it again later
                    Level2.RefMenu = this.RefMenu;
        ...
        //Form size change
        private void Level1_ClientSizeChanged(object sender, EventArgs e)
        {
        ...
        public int ReverseBallSpeed(int n)
        {
            ...
            if (n > 0)
            {
                ...
                // soft limits number to between 20 and 30
                if (n < 30 && n > 20)
                {
                ...
                //if the number is outside the "acceptable speed range (20-30)" the else if and else will slowly set them back
                else if (n < 25)
                {
                    n = -(n) - 5;
                    return n;
            ...
            //i.e. the number was 0 (which it should never be) then this would reset the number to the middle speed 25.
            else
            {
                n = 25;
                return n;
